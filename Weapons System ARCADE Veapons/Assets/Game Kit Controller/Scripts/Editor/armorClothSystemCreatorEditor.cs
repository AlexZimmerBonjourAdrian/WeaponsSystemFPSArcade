...
//				string mainArmorClothPieceTemplateDataPath = AssetDatabase.GetAssetPath (mainArmorClothPieceTemplateData);

//				if (mainArmorClothPieceTemplateDataPath != null && mainArmorClothPieceTemplateDataPath != "") {
//					UnityEngine.Object prefab = (GameObject)AssetDatabase.LoadAssetAtPath (mainArmorClothPieceTemplateDataPath, typeof(GameObject));
//					PrefabUtility.ReplacePrefab (mainArmorClothPieceTemplateData, prefab, ReplacePrefabOptions.ReplaceNameBased);

//					AssetDatabase.CreateAsset (mainArmorClothPieceTemplateData, mainArmorClothPieceTemplateDataPath);
//				}
...
//			string mainCharacterAspectCustomizationTemplateDataPath = AssetDatabase.GetAssetPath (mainCharacterAspectCustomizationTemplateData);

//			if (mainCharacterAspectCustomizationTemplateDataPath != null && mainCharacterAspectCustomizationTemplateDataPath != "") {
//				Debug.Log ("Updating mainCharacterAspectCustomizationTemplateData on path " + mainCharacterAspectCustomizationTemplateDataPath);

//				AssetDatabase.CreateAsset (mainCharacterAspectCustomizationTemplateData, mainCharacterAspectCustomizationTemplateDataPath);
//
//				UnityEngine.Object prefab = (GameObject)AssetDatabase.LoadAssetAtPath (mainCharacterAspectCustomizationTemplateDataPath, typeof(GameObject));
//				PrefabUtility.ReplacePrefab (mainCharacterAspectCustomizationTemplateData, prefab, ReplacePrefabOptions.ReplaceNameBased);
//			}
...
//			string mainFullArmorClothTemplateDataPath = AssetDatabase.GetAssetPath (mainFullArmorClothTemplateData);
//
//			if (mainFullArmorClothTemplateDataPath != null && mainFullArmorClothTemplateDataPath != "") {
//				Debug.Log ("Updating mainFullArmorClothTemplateData on path " + mainFullArmorClothTemplateDataPath);

//				AssetDatabase.CreateAsset (mainFullArmorClothTemplateData, mainFullArmorClothTemplateDataPath);
//
//				UnityEngine.Object prefab = (GameObject)AssetDatabase.LoadAssetAtPath (mainFullArmorClothTemplateDataPath, typeof(GameObject));
//				PrefabUtility.ReplacePrefab (mainFullArmorClothTemplateData, prefab, ReplacePrefabOptions.ReplaceNameBased);
//			}
