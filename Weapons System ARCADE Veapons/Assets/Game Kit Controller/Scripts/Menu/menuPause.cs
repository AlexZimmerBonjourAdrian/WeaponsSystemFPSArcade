...
//		showOrHideMouseCursorController (state);
	...
	public void restart ()
	{
		...
		GKC_Utils.loadScene (SceneManager.GetActiveScene ().buildIndex, useLoadScreen, loadScreenScene, sceneToLoadAsyncPrefsName, useLastSceneIndexAsLoadScreen);
	}
	...
	public void confirmGoToHomeMenu ()
	{
		...
		GKC_Utils.loadScene (sceneNumberForHomeMenu, useLoadScreen, loadScreenScene, sceneToLoadAsyncPrefsName, useLastSceneIndexAsLoadScreen);
	}
