...
public class pathInfoValues : MonoBehaviour
{
	...
	{
		return "Assets/Game Kit Controller/Prefabs/Character Customization/Armor Cloth Templates/";
	}

	public static string getFullSetsCharacterCreationTemplatesPrefabPath ()
	{
		return "Assets/Game Kit Controller/Prefabs/Character Customization/Character Creation Templates/Full Sets/";
	}
