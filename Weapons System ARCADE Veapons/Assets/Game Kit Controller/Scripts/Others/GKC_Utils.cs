...
//							}
	...
	public static void loadScene (int newSceneIndex, bool useLoadScreen, int loadScreenScene, string sceneToLoadAsyncPrefsName, bool useLastSceneIndexAsLoadScreen)
	{
		int sceneLoadIndex = newSceneIndex;

		if (useLoadScreen) {
			PlayerPrefs.SetInt (sceneToLoadAsyncPrefsName, sceneLoadIndex);
